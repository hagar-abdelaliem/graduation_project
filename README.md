...
## 15/10/2022  
  - Participations<br/>
     Hagar , Rehab, Mahmoud and Dr.Dieaa
  - Notes
    - Dieaa explain some project details.<br/>
  ...
  - Tasks
    - [x] We will meet Dr.Alsafa on Tuseday, 18/10/2022 to know all details about the project
## 18/10/2022
  - Participations<br/>
       Mahmoud, Hagar, Rehab, Dr.Alsafa and Dr.Dieaa
  - what we did
      - we go to Dr.Alsafa in her office <br/>
      - she explained some details about the system which she did and currently used in botany department<br/>
  ...
  - Notes
      ...
      - not all informations id clear and we need more time.<br/>
      - this database will take a lot of time to made this.<br/>
  - Tasks
      - [x] Hagar created a whatsApp group and added Dr.Dieaa and Dr.Alsafa. <br/>
...
## 24/10/2022
  ...
  - Notes
      ...
      - we made this database but it have some problem
          - when we made this design we found that there is a many to many relationship between weak entity and strong entity and we didn't see it before in database , but Mahmoud made search and found that it is natural<br/>.
          ...
          - we have no data and we asked Dr.Alsafa to send us the data.
...
## 27/10/2022
  - Participations<br/>
      Hagar , Mahmoud , Rehab , Dr.Alsafa
  - Notes
      - Dr.Alsafa sent a excal sheet which have very littel data and we made a design before we went to Dr.Alsafa, but this is a very little part of data , and not the same data which is treat with in actual.<br/>
      - Dr.Alsafa not send us any another data , and this is a big problem for us because every time we decide to make a design we have a big conflict
      - we asked Dr.Alsafa to send data many times but she apologized because she had a problem in her laptop 
      - Design
      ...
      - Discussion
          - we went to Dr.Alsafa to ask her about this problems
      ...
      - Tasks
          - [x] make new database 
          - [x] make meeting with Dr.Dieaa on 29/10/2022 in his office , to discuss database desgin 
          - [x] determine what is required in project
## 29/10/2022
  - Participations <br/>
      Dr.Dieaa, Mahmoud , Hagar ,Rehab
  - What we did
      - we met Dr.Dieaa in his office to discuss what we have come to in the design of the Database and the following picture contains what we have come to before               meeting him. 
          - ![image](https://user-images.githubusercontent.com/75702509/199990844-7c0bb587-0cae-468e-86d6-ff775e8e0067.png).
      - Dr.Dieaa informed us of some modifications to our design to make it better and easier to obtain information (For this, thank you, Dr.Dieaa).
  - Notes
...
## 2/11/2022
  ...
  - Tasks
      - [x] meeting with Dr.Dieaa on 5/11/2022 to present the final database design for the last time before moving on to the next step in our project.
## 5/11/2022
  - Participations <br/>
      Dr.Dieaa, Hagar, Rehab ,Mahmoud  
  - What we did
      - we display our final design and we have some problems 
          - when the student return the sile we must mark the field that this slide has returned, but the search about this student is not easy , so Dr.Dieaa suggested that 
              - we can add attribute form number to the borrow table.  
              - we must add attribute of English name.
              - we will add other attribute of returned data in borrow table.
      - we Finally reached to the final design of database.
  - tasks
      - [x] Mahmoud will add this attributes in the database.
      - [x] untill 23/11/2022 we will collect all informations about firebase untill we finished midterm exams    
## 24/11/2022
  - Participations <br/>
     Hagar, Rehab ,Mahmoud
  - what we do
      - we agree about what we must do.  
  - Tasks
...
## 27/11/2022
  - Participations <br/>
      Mahmoud , Hagar ,Rehab 
  - What we did
      - we make meeting on microsoft team and we spend 5 hours on making relational model and making database in workbanch
  ...
  - tasks
      ...
      - [x] hagar and rehab will make the sign in in firebase.
      - [x] hagar & rehab will search about how we will design tables in firebase & how to make relations between the tables.
## 28/11/2022
  - Participations <br/>
      Hagar ,Rehab, Mahmoud.
  - What we did
      - we make meeting on microsoft and we unit versions of dart and flutter.
      - hagar make empty project and upload it in our githup.
  - tasks
      - [x] rehab will add firebase in our project & will write the documentation of the way to add fireabse to any project.
      - [x] we make models of tables in our project in android studio.
